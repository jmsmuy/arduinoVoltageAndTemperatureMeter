...
public:
  ...
  void setTemperature(long numToShow, char decPlaces, bool hex=0);
...
private:
  void setNewNum(long numToShow, char decPlaces, bool hex=0, bool isTemp=0);
  void findDigits(long numToShow, char decPlaces, bool hex, byte digits[], bool isTemp);
